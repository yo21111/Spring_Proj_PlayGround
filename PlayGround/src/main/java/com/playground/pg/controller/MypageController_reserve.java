...
public class MypageController_reserve {
	...
	public String showReList_Detail(int reserveNo, Model m) throws Exception {
		...
		return "mypage_reserve_detail";
	}

	// 예매목록 상세 페이지
	@GetMapping("/reList_delete")
	public String showReList_Delete(int reserveNo, Model m) throws Exception {
		// 예매번호 매개변수로 받기
	...
	public String updateReserve(ReserveDto reserveDto, String date, String time1, String time2) {
